package com.nerojust.arkandarcsadmin.admin.adapters;
...
import com.nerojust.arkandarcsadmin.admin.views.orders.AdminOrderDetailsActivity;
...
public class CompletedOrderAdapter extends RecyclerView.Adapter<CompletedOrderAdapter.OrdersViewHolder> {
    ...
    public void onBindViewHolder(@NonNull OrdersViewHolder holder, int position) {
        ...
        holder.orderStatus.setTextColor(context.getResources().getColor(R.color.arkandarcs_green));
