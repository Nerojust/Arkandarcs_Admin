package com.nerojust.arkandarcsadmin.admin.views.register;
    ...
    private void registerUser() {
        ...
        webServiceRequestMaker.registerUser(registrationSendObject, new RegisterInterface() {
            ...
            public void onSuccess(RegistrationResponse registrationResponse) {
                Toast.makeText(AdminRegisterActivity.this, registrationResponse.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onError(String error) {
                Toast.makeText(AdminRegisterActivity.this, error, Toast.LENGTH_SHORT).show();
                AppUtils.dismissLoadingDialog();
            }

            @Override
            public void onErrorCode(int errorCode) {
                Toast.makeText(AdminRegisterActivity.this, errorCode + "", Toast.LENGTH_SHORT).show();
                AppUtils.dismissLoadingDialog();
            }
        });
        ...
        countrySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (countrySpinner.getSelectedItem().equals("NIGERIA")) {
                    ArrayAdapter adapter2 = ArrayAdapter.createFromResource(AdminRegisterActivity.this,
                    ...
                    stateOfOriginSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                            if (stateOfOriginSpinner.getSelectedItem().equals("Abia")) {
                                ArrayAdapter adapter21 = ArrayAdapter.createFromResource(AdminRegisterActivity.this,
                                ...
                                lgaAdapter = ArrayAdapter.createFromResource(AdminRegisterActivity.this,
