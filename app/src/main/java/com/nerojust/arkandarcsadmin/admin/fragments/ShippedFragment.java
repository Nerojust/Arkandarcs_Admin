...
import com.nerojust.arkandarcsadmin.admin.adapters.ShippedOrderAdapter;
...
public class ShippedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.fragment_shipped, container, false);
        initViews(view);
    ...
    private void initViews(View view) {
        ...
        recyclerView = view.findViewById(R.id.recycler_shipped);
    ...
    private void getAllOrders() {
        ...
        webServiceRequestMaker.getAllShippedorders(new OrdersInterface() {
            @Override
            public void onSuccess(OrdersResponse response) {
                ShippedOrderAdapter ordersAdapter = new ShippedOrderAdapter(response, getContext());
