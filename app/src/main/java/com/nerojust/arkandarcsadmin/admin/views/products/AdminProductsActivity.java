...
import com.nerojust.arkandarcsadmin.admin.adapters.ProductAdapter;
    ...
    private void getAllProducts() {
        ...
        webServiceRequestMaker.getAllProducts(new ProductInterface() {
            ...
            public void onError(String error) {
                AppUtils.showDialog(error, AdminProductsActivity.this);
                Toast.makeText(AdminProductsActivity.this, error, Toast.LENGTH_SHORT).show();
                if (swipeRefreshLayout.isRefreshing()) {
                    swipeRefreshLayout.setRefreshing(false);
                }
                AppUtils.dismissLoadingDialog();
            ...
            public void onErrorCode(int errorCode) {
                Toast.makeText(AdminProductsActivity.this, errorCode + "", Toast.LENGTH_SHORT).show();
                if (swipeRefreshLayout.isRefreshing()) {
                    swipeRefreshLayout.setRefreshing(false);
                }
                AppUtils.dismissLoadingDialog();
