package com.nerojust.arkandarcsadmin.admin.views;
...
import com.nerojust.arkandarcsadmin.admin.views.orders.AdminOrdersActivity;
import com.nerojust.arkandarcsadmin.admin.views.products.AdminProductsActivity;
import com.nerojust.arkandarcsadmin.admin.views.transactions.AdminTransactionsActivity;
import com.nerojust.arkandarcsadmin.admin.views.users.UsersActivity;
import com.nerojust.arkandarcsadmin.utils.AppUtils;

import java.util.ArrayList;

public class AdminDashBoardActivity extends AppCompatActivity implements BaseSliderView.OnSliderClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String firstName = AppUtils.getSessionManagerInstance().getFirstName();
        nameTextview.setText("Welcome " + firstName);

        findViewById(R.id.productCardview).setOnClickListener(v -> startActivity(new Intent(this, AdminProductsActivity.class)));
        findViewById(R.id.usersCardview).setOnClickListener(v -> startActivity(new Intent(this, UsersActivity.class)));
        findViewById(R.id.ordersCardview).setOnClickListener(v -> startActivity(new Intent(this, AdminOrdersActivity.class)));
        findViewById(R.id.transactionCardview).setOnClickListener(v -> startActivity(new Intent(this, AdminTransactionsActivity.class)));
    }
