package com.nerojust.arkandarcsadmin.admin.views.transactions;
...
import com.nerojust.arkandarcsadmin.admin.adapters.TransactionAdapter;
    ...
    private void getAllTransactions() {
        ...
        webServiceRequestMaker.getAllTransactions(new TransactionsInterface() {
            ...
            public void onSuccess(TransactionResponse response) {
                TransactionAdapter transactionAdapter = new TransactionAdapter(response, AdminTransactionsActivity.this);
            ...
            public void onError(String error) {
                Toast.makeText(AdminTransactionsActivity.this, error, Toast.LENGTH_SHORT).show();
                if (swipeRefreshLayout.isRefreshing()) {
                    swipeRefreshLayout.setRefreshing(false);
                }
                AppUtils.dismissLoadingDialog();
            ...
            public void onErrorCode(int errorCode) {
                Toast.makeText(AdminTransactionsActivity.this, errorCode + "", Toast.LENGTH_SHORT).show();
                if (swipeRefreshLayout.isRefreshing()) {
                    swipeRefreshLayout.setRefreshing(false);
                }
                AppUtils.dismissLoadingDialog();
