...
public class PendingOrderAdapter extends RecyclerView.Adapter<PendingOrderAdapter.OrdersViewHolder> {

    private OrdersResponse ordersResponse;
    private Context context;

    public PendingOrderAdapter(OrdersResponse ordersResponse, Context context) {
    ...
    public OrdersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.order_items_pending, parent, false);
...
//        if (ordersResponse.getResults().get(position).getOrderStatus().equals("Pending")) {
    ...
    public int getItemCount() {
        ...
        for (int i = 0; i < ordersResponse.getResults().size(); i++) {
            if (ordersResponse.getResults().get(i).getOrderStatus().equals("Pending")) {
                count++;
            }
        }
       // return count;
