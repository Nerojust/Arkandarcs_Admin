...
public class CompletedOrderAdapter extends RecyclerView.Adapter<CompletedOrderAdapter.OrdersViewHolder> {

    private OrdersResponse ordersResponse;
    private Context context;

    public CompletedOrderAdapter(OrdersResponse ordersResponse, Context context) {
    ...
    public OrdersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.order_items_completed, parent, false);
    ...
    public void onBindViewHolder(@NonNull OrdersViewHolder holder, int position) {
        ...
        //if (ordersResponse.getResults().get(position).getOrderStatus().equals("Completed")) {
    ...
    public int getItemCount() {
        ...
        for (int i = 0; i < ordersResponse.getResults().size(); i++) {
            if (ordersResponse.getResults().get(i).getOrderStatus().equals("Completed")) {
                count++;
            }
        }
        //return count;
